...
- 🎟️ **Propustky (streak freeze)** — za každých 10 tréninků získáš propustku (max 3, zlaté lístky vedle nastavení). Když vynecháš tréninkový den, propustka se po návratu k tréninku uplatní automaticky a tempo se nezlomí; krytý den má v kalendáři čárkovaný rámeček s lístkem. Když je výpadek delší, než na kolik propustky stačí, streak poctivě spadne — ale propustky zůstanou na příště. Dodatečné razítko na krytý den propustku vrátí.
...
- 📋 **Hotové plány** — v režimu úprav si jedním ťuknutím nahraješ šablonu do všech tréninkových dnů: „Cesta k 10 shybům“ (síla / objem / technika), „Full body 3 dny“ (12týdenní program) nebo původní okruh.
